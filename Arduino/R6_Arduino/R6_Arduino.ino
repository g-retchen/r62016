...
//initialize SharpIR values and functions
//#define model "GP2Y0A02YK"a
//const uint8_t model = "GP2Y0A02YK";
#define ir A0    //front sensor
#define ir2 A1
#define ir3 A2
SharpIR sharp1("GP2Y0A02YK", ir);
//SharpIR sharp2(ir2, model);
//SharpIR sharp3(ir3, model);
...
// IMU
int updated_heading;
int heading_delta; //Are these used????
char fwd;
char turn;
